create or replace procedure sendNotificationEtatCompetitionQualification(p_competition_id int)
begin
    ...
    loop
        ...
        call sendNotificationToEcurie(cur_ecu_id, concat(
                'La phase de qualification de la compétition de ',
                competition_name,
                ' a débuté. Vous pouvez visualiser les poules de qualification sur le detail de la compétition en question.'
            ));
